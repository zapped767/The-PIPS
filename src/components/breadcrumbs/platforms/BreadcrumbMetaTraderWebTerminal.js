...
const BreadcrumbMetaTraderWebTerminal = () => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <h1>MetaTrader Web Terminal</h1>
              <p>
                Trade from your browser - no downloads, instant access anytime.
              </p>
              <Link
...
BreadcrumbMetaTraderWebTerminal.propTypes = {
  title: PropTypes.string,
};

export default BreadcrumbMetaTraderWebTerminal;
