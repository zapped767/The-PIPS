        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <h1>MetaTrader 4 (MT4)</h1>
              <p>Trade with precision, speed, and full control.</p>
              <Link
...
BreadcrumbMetaTrader4.propTypes = {
  title: PropTypes.string,
};

export default BreadcrumbMetaTrader4;
