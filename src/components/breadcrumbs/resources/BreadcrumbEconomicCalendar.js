...
const BreadcrumbEconomicCalendar = () => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              <p>
                Monitor and analyze market-moving events, data releases, and
                global economic announcements - all in one place, in real time.
              </p>
              <div>
                <a
...
BreadcrumbEconomicCalendar.propTypes = {
  title: PropTypes.string,
};

export default BreadcrumbEconomicCalendar;
